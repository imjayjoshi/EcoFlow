    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg border enterprise-shadow">
        <div className="flex items-center justify-between border-b px-5 py-3">
          ...
          <Link to="/ecos" className="text-xs font-medium text-muted-foreground hover:text-foreground flex items-center gap-1">
            View all <ArrowRight className="h-3 w-3" />
          </Link>
        </div>
        <div className="divide-y">
          {ecos.slice(0, 4).map((eco) => (
            <Link key={eco.id} to={`/ecos/${eco.id}`} className="flex items-center justify-between px-5 py-3 hover:bg-muted/50 transition-colors">
      ...
      <div className="bg-card rounded-lg border enterprise-shadow">
        ...
        <div className="divide-y">
          {activeProducts.map((p) => (
            <Link key={p.id} to={`/products/${p.id}`} className="flex items-center justify-between px-5 py-3 hover:bg-muted/50 transition-colors">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="bg-card rounded-lg border enterprise-shadow p-5">
          ...
          <div className="space-y-2">
            ...
            <Link to="/audit-logs" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
