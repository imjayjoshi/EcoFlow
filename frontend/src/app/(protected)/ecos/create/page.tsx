...
export default function ECOCreate() {
    ...
    return (
        <div className="space-y-6 max-w-2xl">
            <Link href="/ecos" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
            ...
            <div className="flex items-center gap-4">
                {[1, 2].map((s) => (
                    <div key={s} className="flex items-center gap-2">
                        <div className={`flex h-7 w-7 items-center justify-center rounded-full text-xs font-semibold ${step >= s ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                            }`}>
            ...
            <div className="bg-card rounded-lg border enterprise-shadow p-6">
                            ...
                            <div className="flex gap-3">
                                {(["product", "bom"] as const).map((t) => (
                                    <button
                                        ...
                                        className={`rounded-md border px-4 py-2 text-sm font-medium transition-colors ${form.type === t
                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t">
                    ...
                    {step < 2 ? (
                        ...
                        <Button onClick={() => router.push("/ecos")}>
                            Save as Draft
                        </Button>
                    )}
                </div>
